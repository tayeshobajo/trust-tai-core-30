/**
 * Drafts held at the human boundary.
 *
 * The old Queue page, now a section of Drafts & Reviews. Behaviour is
 * unchanged: a draft is reviewed, rejected or sent through the one governed
 * send endpoint, which refuses anything without a current approval of those
 * exact words. Nothing here approves on its own.
 */
...
export function DraftQueue({ identity }: { identity: WorkspaceIdentity }) {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-[15px] text-foreground">Waiting for your review</h2>
        <p className="text-[13px] text-muted-foreground">
          Drafts held at the human boundary. Each one opens its single review record; nothing leaves
