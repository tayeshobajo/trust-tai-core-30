...
describe("decideSend", () => {
  ...
  it.each([
    ...
    ["the review never finished", { run: { id: "run-1", status: "failed", contextRevision: 4 } }, "review_incomplete"],
    ["the approved run is gone", { run: null }, "review_incomplete"],
    ["the message was edited after approval", { payloadFingerprint: "different" }, "payload_changed"],
