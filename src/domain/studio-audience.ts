...
export function scopeNote(
  ...
  return `Counted from the ${returned.toLocaleString("en-US")} ${returned === 1 ? "person" : "people"} the website returned. The website hasn't confirmed these are everyone yet.`;
}
